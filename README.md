...
- An advantage of refactoring code is that there is better readablity, the code is clean and much easier to comprehend. The time to run the code has also reduced by 
